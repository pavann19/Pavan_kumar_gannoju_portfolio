      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <GlassCard className="p-8 md:p-12 text-center" delay={0.1}>
          <div className="flex flex-col items-center justify-center gap-8">
            <div className="p-4 bg-[#1e293b] rounded-full border border-[#334155] shadow-lg shadow-black/20">
              <FaGithub className="w-12 h-12 text-[#f8fafc]" />
            </div>
            
            <div className="space-y-4">
              <h3 className="text-3xl font-bold text-[#f8fafc]">@pavann19</h3>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
              <span className="px-4 py-2 bg-[#0f172a] rounded-full text-xs font-mono text-[#60a5fa] border border-[#1e293b] flex items-center gap-2">
            ...
            <a 
              ...
              className="mt-6 inline-flex items-center gap-2 px-8 py-4 bg-[#60a5fa] hover:bg-[#3b82f6] text-[#0f172a] font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-[0_0_20px_rgba(96,165,250,0.3)] hover:shadow-[0_0_30px_rgba(96,165,250,0.5)]"
            >
              View GitHub Profile
