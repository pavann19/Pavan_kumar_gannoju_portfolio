    ...
    <div className="flex flex-wrap items-center gap-2 mt-4">
      {steps.map((step, i) => (
        <React.Fragment key={i}>
          <div className="bg-[#0f172a] border border-[#e2e8f0] px-3 py-2 rounded shadow-sm text-sm font-mono text-[#334155] whitespace-nowrap">
            {step}
          </div>
          {i < steps.length - 1 && (
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="space-y-12">
          {featuredProjects.map((project, idx) => (
            <GlassCard key={idx} className="p-0 overflow-hidden group bg-[#0f172a] border-[#e2e8f0]" delay={idx * 0.1}>
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-[55%] p-6 sm:p-8 lg:p-12 bg-[#ffffff] flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 w-full p-4 sm:p-6 rounded-xl border border-[#e2e8f0] bg-[#0f172a] shadow-lg">
